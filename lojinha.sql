...
values (1,1,10);
 ...
 delete from carrinho where pedido = '1'; 
...
(produtos.custo + ((custo * lucro) / 100)) * carrinho.quantidade as sub_total -- (custo + lucro) * quantidade -- 
...
-- SEMPRE QUE EU QUISER FZER UPDATE EM DUAS TABELAS AO MSM TEMPO PRECISO USAR O INNER JOIN --
